...
def plotten(phi, I):
    ...
    phi_d, I_d = np.genfromtxt('data/difscan.UXD', unpack=True) #Messdaten des diffusen Scans
    ...
    ax1.axvline(x=qcrit_PS, ymin=0, ymax=1, linestyle='dashed', linewidth = 0.7, color='#ABB2B9', label=r'$\alpha_c$ für PS') #Vertikales Plotten des Winkels
